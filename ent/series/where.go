...
func ID(id uint32) predicate.Series {
...
func IDEQ(id uint32) predicate.Series {
	return predicate.Series(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint32) predicate.Series {
	return predicate.Series(func(s *sql.Selector) {
...
func IDIn(ids ...uint32) predicate.Series {
	return predicate.Series(func(s *sql.Selector) {
...
func IDNotIn(ids ...uint32) predicate.Series {
	return predicate.Series(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id uint32) predicate.Series {
	return predicate.Series(func(s *sql.Selector) {
...
func IDGTE(id uint32) predicate.Series {
	return predicate.Series(func(s *sql.Selector) {
...
func IDLT(id uint32) predicate.Series {
	return predicate.Series(func(s *sql.Selector) {
...
func IDLTE(id uint32) predicate.Series {
	return predicate.Series(func(s *sql.Selector) {
