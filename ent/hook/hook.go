...
// The DropFunc type is an adapter to allow the use of ordinary
// function as Drop mutator.
type DropFunc func(context.Context, *ent.DropMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DropFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.DropMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DropMutation", m)
	}
	return f(ctx, mv)
}
